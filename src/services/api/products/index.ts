...
export const getAllProducts = async (
    ...
    const response = await axiosInstance.get(getAllProductsUrl, { params });
    return response.data;
};
...
export const updateProduct = async (
    ...
    const response = await axiosInstance.put(updateProductUrl(productId), payload);
    return response.data;
};
...
export const getProductsByCollection = async (
    ...
    const response = await axiosInstance.get(productsByCollectionUrl(data.collectionId), {
